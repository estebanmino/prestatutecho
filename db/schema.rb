...
ActiveRecord::Schema.define(version: 20161102044950) do
  ...
  create_table "groups", force: :cascade do |t|
    ...
    t.datetime "updated_at",                         null: false
    t.string   "group"
    t.integer  "recovery_time",      default: 0
    t.boolean  "accepted",           default: false
    t.integer  "total_investment",   default: 0
    t.integer  "minimal_investment", default: 0
  end
